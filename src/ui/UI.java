...
public class UI {
    ...
    private String fixLengthString(int start, int length) {
        ...
        return fixLengthString(startString, length);
         ...
         public void printMaterialCatalog(TreeMap<String, Material> materialCatalog) {//implicit way of saying nextBook.toString

        for (Material nextMaterial : materialCatalog.values())
        {
            System.out.println(nextMaterial.toString());//toString är redundant med bara som förtydligande
        }//både dvd och book har toString method som override Materials toString
    }
